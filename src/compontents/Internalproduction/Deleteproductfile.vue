      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <el-button type="warning" @click="review(scope.row.id)" size="small">未删除</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!-- 分页-->
          ...
          <el-row>
            ...
            <el-col>
              <el-form-item>
                ...
                <el-button type="primary" @click="btnsave">删除</el-button>
              </el-form-item>
            </el-col>
          </el-row>
        </el-form>
    ...
    export default {
      ...
      methods:{
        ...
        btnsave(){   //编辑模态框  保存按钮按下
          ...
          this.$axios.post("dfile/modifydel.action",params).then(function (response) {
