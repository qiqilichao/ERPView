<template>
    <div id="Productfilerecovery">
      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <el-button type="warning" @click="review(scope.row.id)" size="small">已删除</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!-- 分页-->
      ...
      <!--产品复核编辑-->
      <el-dialog title="产品" :visible="editwinshow">
          ...
          <el-row>
            ...
            <el-col>
              <el-form-item>
                ...
                <el-button type="primary" @click="btnsave">恢复删除</el-button>
              </el-form-item>
            </el-col>
          </el-row>
        </el-form>
    ...
    export default {
      ...
      methods:{
        getdfiledata() {
          ...
          this.$axios.post("dfile/approveddel.action", params).then((response) => {
        ...
        btnsave(){   //编辑模态框  保存按钮按下
          ...
          this.$axios.post("dfile/recoverdeleted.action",params).then(function (response) {
