<template>
    <div id="Productfilesarepermanentlydeleted">
      <h1>产品档案永久删除</h1>
      <!-- 表格数据-->
      <el-table
        :data="dfiletable"
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <el-button type="warning" @click="review(scope.row.id)" size="small">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!-- 分页-->
          ...
          <el-row>
            ...
            <el-col>
              <el-form-item>
                ...
                <el-button type="primary" @click="btnsave">彻底删除</el-button>
              </el-form-item>
            </el-col>
          </el-row>
        </el-form>
...
<script>
    export default {
        name: "Productfilesarepermanentlydeleted",
      data(){
        return{
          dfiletable:[],
          pageno: 1,
      ...
      methods:{
        ...
        btnsave(){   //编辑模态框  保存按钮按下
          ...
          this.$axios.post("dfile/permanentlydelete.action",params).then(function (response) {
